...
program
  ...
  .option("--max-count <count>", "Max number of backups to retain", (value) => Number(value))
  .option("--max-total-size-mb <mb>", "Max total retained backup size in MiB", (value) => Number(value))
