...
- Paperclip injects \`PAPERCLIP_AGENT_ID\`, \`PAPERCLIP_COMPANY_ID\`, \`PAPERCLIP_API_URL\`, \`PAPERCLIP_RUN_ID\`, and \`PAPERCLIP_API_KEY\` for heartbeat runs. Mutating issue API calls should use \`Authorization: Bearer $PAPERCLIP_API_KEY\` and \`X-Paperclip-Run-Id: $PAPERCLIP_RUN_ID\`.
